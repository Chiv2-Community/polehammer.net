...
export function generateMetrics(inputWeapons: Weapon[], numberOfTargets: number, horsebackDamageMult: number, target: Target): WeaponStats {
 ...
 //   new WeaponMetric(MetricLabel.RANK, Unit.RANK, (w) => ALL_WEAPONS_RANKS.get(w.id)?.get("AVERAGE_RANK_RANK") as number),
    ...
    new InverseMetric(MetricLabel.WINDUP_OVERHEAD_HEAVY, MetricPath.WINDUP_SLASH_HEAVY),
    new InverseMetric(MetricLabel.WINDUP_STAB_LIGHT, MetricPath.WINDUP_SLASH_LIGHT),
    new InverseMetric(MetricLabel.WINDUP_STAB_HEAVY, MetricPath.WINDUP_SLASH_HEAVY),
    ...
    new InverseMetric(MetricLabel.RECOVERY_OVERHEAD_HEAVY, MetricPath.RECOVERY_SLASH_HEAVY),
    new InverseMetric(MetricLabel.RECOVERY_STAB_LIGHT, MetricPath.RECOVERY_SLASH_LIGHT),
    new InverseMetric(MetricLabel.RECOVERY_STAB_HEAVY, MetricPath.RECOVERY_SLASH_HEAVY),
    ...
    new BasicMetric(MetricLabel.RELEASE_OVERHEAD_HEAVY, MetricPath.RELEASE_SLASH_HEAVY),
    new BasicMetric(MetricLabel.RELEASE_STAB_LIGHT, MetricPath.RELEASE_SLASH_LIGHT),
    new BasicMetric(MetricLabel.RELEASE_STAB_HEAVY, MetricPath.RELEASE_SLASH_HEAVY),
