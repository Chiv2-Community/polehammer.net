...
export function generateMetrics(inputWeapons: Weapon[], numberOfTargets: number, horsebackDamageMult: number, target: Target): WeaponStats {
 ...
 //   new WeaponMetric(MetricLabel.RANK, Unit.RANK, (w) => ALL_WEAPONS_RANKS.get(w.id)?.get("AVERAGE_RANK_RANK") as number),
    ...
    new InverseMetric(MetricLabel.RIPOSTE_SLASH_LIGHT, MetricPath.RIPOSTE_SLASH_LIGHT),
    new InverseMetric(MetricLabel.RIPOSTE_SLASH_HEAVY, MetricPath.RIPOSTE_SLASH_HEAVY),
    new InverseMetric(MetricLabel.RIPOSTE_OVERHEAD_LIGHT, MetricPath.RIPOSTE_OVERHEAD_LIGHT),
    new InverseMetric(MetricLabel.RIPOSTE_OVERHEAD_HEAVY, MetricPath.RIPOSTE_OVERHEAD_HEAVY),
    new InverseMetric(MetricLabel.RIPOSTE_STAB_LIGHT, MetricPath.RIPOSTE_STAB_LIGHT),
    new InverseMetric(MetricLabel.RIPOSTE_STAB_HEAVY, MetricPath.RIPOSTE_STAB_HEAVY),
    new InverseMetric(MetricLabel.RIPOSTE_SPECIAL, MetricPath.RIPOSTE_SPECIAL),
    new InverseMetric(MetricLabel.RIPOSTE_LEAPING_STRIKE, MetricPath.RIPOSTE_LEAPING_STRIKE),
    new InverseMetric(MetricLabel.RIPOSTE_SPRINT_CHARGE, MetricPath.RIPOSTE_SPRINT_CHARGE),
    new InverseMetric(MetricLabel.RIPOSTE_THROW, MetricPath.RIPOSTE_THROW),
